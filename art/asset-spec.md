...
### 2.2 冲锋怪 锥冲 `chong_feng`（地面冲锋 / 不可踩 / 长条楔形 / 钢蓝）— 重点
- **造型（✅ 原创，非龟壳）**：长条楔形（前尖后宽），钢蓝 `#3D6FB4` 主体，深钢蓝 `#2C5588` 背光，浅钢蓝 `#6FA0D8` 前缘高光，**前端警示红尖 `#E8483B`** 警示，白眼，描边 `#2A1A12`。
...
- **可踩视觉暗示：hard**——楔形前尖（钢蓝 + 警示红尖）= "硬/别碰顶"；顶部硬棱/尖，配警示红强化（形状为主、色为辅）。色盲安全：楔形尖角轮廓。`stompable=false`（踩则玩家伤）。
